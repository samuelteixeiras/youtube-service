package cs.youtube.auth.bearer;

import cs.youtube.auth.jwt.AuthorizationHeaderPayload;
import cs.youtube.auth.jwt.JWTCustomVerifier;
import cs.youtube.auth.jwt.UsernamePasswordAuthenticationBearer;
